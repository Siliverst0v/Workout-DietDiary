...
//    @Environment(\.dismiss) var dismiss
    ...
    var body: some View {
        ...
        Image("TappedCell")
            .resizable()
            .frame(width: UIScreen.main.bounds.size.width - 40, height: backgroundHeight + CGFloat(((choosenExercise.sets.count - 1) * 30)))
...
struct PreviousExercises_Previews: PreviewProvider {
    static var previews: some View {
        PreviousExercises(choosenExercise: RealmChoosenExercise(icon: "back", title: "daksmmdkfskd"))
    }
}
