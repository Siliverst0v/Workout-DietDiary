...
class Exercises: ObservableObject {
    ...
    func getMocExercise() -> RealmChoosenExercise {
        let exercise = RealmChoosenExercise(icon: "back", title: "Exercise for example", note: "Some note here")
